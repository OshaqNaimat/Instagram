                 ...
                 {/* </label> */}
                  ...
                  <div className="flex justify-between items-center w-full my-3 p-2 ">
                    <div className="flex gap-3">
                      <FaRegHeart size={25} className='cursor-pointer hover:text-gray-500 duration-100 '/>
                      <FaRegComment size={25} className='cursor-pointer hover:text-gray-500 duration-100' />
                      <RiSendPlaneFill size={25} className='cursor-pointer hover:text-gray-500 duration-100' />
                    </div>
                    <FiBookmark size={25} className='cursor-pointer hover:text-gray-500 duration-100'/>
                  </div>
                  <div className="px-2 m-0 font-semibold">
                    100 likes
                  </div>
